...
public enum BlockData implements Craftable {
    ...
    OAK_LOG((byte) 7, "Oak Log", false, false, new MaterialID[]{MaterialID.WOOD}, 100, 6, 0, 6, 2, 6, 1, SoundGroup.HARD, 1.2f),
    ...
    COPPER_ORE((byte) 11, "Copper Ore", 150, 10, 0, SoundGroup.HARD, 1.0f, false, new MiningComponent[]{new MiningComponent(Tier.COPPER, MaterialID.ORE)}),
