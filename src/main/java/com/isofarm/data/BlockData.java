...
public enum BlockData implements Craftable {
    AIR((byte) 0, (byte) 0, "Empty", false, 0, null, SoundGroup.SILENT, 0f, true, new Object[]{}, Tier.NONE),
    DIRT((byte) 1, (byte) 0, "Dirt", true, 100, "assets/textures/blocks/dirt.png", SoundGroup.SOIL, 0.9f, false, new Object[]{}, Tier.NONE),
    GRASS((byte) 2, (byte) 0, "Grass", true, 120, "assets/textures/blocks/grass.png", SoundGroup.SOIL, 1.0f, false, new Object[]{}, Tier.NONE),
    STONE((byte) 3, (byte) 0, "Stone", false, 150, "assets/textures/blocks/stone.png", SoundGroup.HARD, 6.0f, false,  new Object[]{}, Tier.NONE),
    TILLED_DIRT((byte) 4, (byte) 0, "Tilled Dirt", true, 110, "assets/textures/blocks/dirt_tilled.png", "assets/textures/blocks/dirt.png", "assets/textures/blocks/dirt.png", SoundGroup.SOIL, 0.9f, false, new Object[]{}, Tier.NONE),
    VOIDSTONE((byte) 5, (byte) 0, "Voidstone", false, 999, "assets/textures/blocks/voidstone.png", SoundGroup.HARD, 999999.0f, false,  new Object[]{}, Tier.NONE),
    GLASS((byte) 6, (byte) 0, "Glass", false, 200, "assets/textures/blocks/glass.png", SoundGroup.GLASS, 1.2f, true,  new Object[]{}, Tier.NONE),
    OAK_LOG((byte) 7, (byte) 0, "Oak Log", false, 100, "assets/textures/blocks/oak_log_top.png", "assets/textures/blocks/oak_log_bottom.png", "assets/textures/blocks/oak_log_side.png", SoundGroup.HARD, 2.2f, false,  new Object[]{}, Tier.WOOD),
    OAK_WOOD((byte) 8, (byte) 0, "Oak Wood", false, 100, "assets/textures/blocks/oak_plank.png", SoundGroup.HARD, 4.0f, false,  new Object[]{}, Tier.WOOD),
    OAK_LEAVES((byte) 9, (byte) 0, "Oak Leaves", false, 100, "assets/textures/blocks/oak_leaves.png", SoundGroup.SOIL, 1.1f, false,  new Object[]{MaterialID.STICK}, Tier.NONE),
    SNOW((byte) 10, (byte) 0, "Snow", false, 120, "assets/textures/blocks/snow.png", SoundGroup.SNOW, 0.8f, false,  new Object[]{}, Tier.NONE),
    ...
    BLUE_FLOWER((byte) 19, (byte) 0, "Blue Flower", false, 10, "assets/textures/blocks/blue_flower.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    BRIGHT_FLOWER((byte) 20, (byte) 0, "Bright Flower", false, 10, "assets/textures/blocks/bright_flower.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    GHOSTFLOWER((byte) 21, (byte) 0, "Ghostflower", false, 15, "assets/textures/blocks/ghostflower.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    LILLY((byte) 22, (byte) 0, "Lilly", false, 10, "assets/textures/blocks/lilly.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    RED_MUSHROOM((byte) 23, (byte) 0, "Red Mushroom", false, 15, "assets/textures/blocks/red_mushroom.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    ROSE((byte) 24, (byte) 0, "Rose", false, 10, "assets/textures/blocks/rose.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    ROSE_SHORT((byte) 25, (byte) 0, "Short Rose", false, 10, "assets/textures/blocks/rose_short.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    ROSEBUSH((byte) 26, (byte) 0, "Rosebush", false, 20, "assets/textures/blocks/rosebush.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    ROSES((byte) 27, (byte) 0, "Roses Cluster", false, 15, "assets/textures/blocks/roses.png", SoundGroup.SOIL, 0.01f, true,  new Object[]{}, Tier.NONE),
    SHORT_GRASS((byte) 28, (byte) 0, "Short Grass", false, 5, "assets/textures/blocks/short_grass.png", SoundGroup.SOIL, 0.01f, true, new Object[]{new Seed(CropType.WHEAT)}, Tier.NONE),
    TALL_GRASS((byte) 29, (byte) 0, "Tall Grass", false, 5, "assets/textures/blocks/tall_grass.png", SoundGroup.SOIL, 0.01f, true, new Object[]{new Seed(CropType.WHEAT)}, Tier.NONE),
    TULIP((byte) 30, (byte) 0, "Tulip", false, 10, "assets/textures/blocks/tulip.png", SoundGroup.SOIL, 0.01f, true, new Object[]{}, Tier.NONE),
    WATER((byte) 127, (byte) -1, "Water", false, 80, "assets/textures/blocks/water.png", SoundGroup.WATER, 0.0f, true, new Object[]{}, Tier.NONE);
    ...
    BlockData(byte id, byte row, String name, boolean isTillable, int value,
    ...
    BlockData(byte id, byte row, String name, boolean isTillable, int value, String texturePath, SoundGroup soundGroup, float destroyTime,
